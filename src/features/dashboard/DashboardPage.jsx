...
import DailyExpenseManager from '../daily-expense-manager/DailyExpenseManagerPage.jsx';
import ExpenseEntryView from '../daily-expense/DailyExpensePage.jsx';
  ...
  if (activeItemId === 'journal-entry') {
    return (
      <JournalEntryView
        ...
        onBack={() => onNavigate('journal-manager')}
      />
    );
  }
